...
// TORCH-CHECK:       %result = torch.aten.mul.Tensor %arg0_input, %arg1_mul : !torch.vtensor<[2,3,128,128],f32>, !torch.vtensor<[128],f32> -> !torch.vtensor<[2,3,128,128],f32>
...
ErrorObject test_pointwise_asm_emitter_mul(const std::string &mode) {
  const int64_t n = 2, c = 3, h = 128, w = 128;
